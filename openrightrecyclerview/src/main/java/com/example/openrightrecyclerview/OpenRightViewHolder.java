package com.example.openrightrecyclerview;
...
public class OpenRightViewHolder extends RecyclerView.ViewHolder{
    ...
    public void setOnFrameLayoutClickedListener(final OnOpenRightViewClickedListener onOpenRightViewClickedListener1){
        this.onOpenRightViewClickedListener = onOpenRightViewClickedListener1;
    ...
    interface OnOpenRightViewClickedListener {
        ...
        void onOpenRightViewClicked(ViewGroup viewGroup, int position);
